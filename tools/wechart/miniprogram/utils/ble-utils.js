...
const BLE_FILM_TRANS_CH_CTRL_FILM_HEARTBEAT_URL = 0x3E; // HTTP心跳地址设置
const BLE_FILM_TRANS_CH_CTRL_FILM_HEARTBEAT_URL_GET = 0x3F; // HTTP心跳地址查询
const BLE_FILM_TRANS_CH_CTRL_FILM_HEARTBEAT_INTERVAL = 0x40; // 心跳间隔设置（1字节，5-180秒）
const BLE_FILM_TRANS_CH_CTRL_FILM_HEARTBEAT_INTERVAL_GET = 0x41; // 心跳间隔查询
...
module.exports = {
  ...
  BLE_FILM_TRANS_CH_CTRL_SCREEN_RESOLUTION_GET,
